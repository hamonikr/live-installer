...
class InstallerWindow:
    ...
    def i18n(self):
        ...
        self.builder.get_object("headerbar").set_title("HamoniKR 6.0 Debian Edition")
        ...
        # Welcome page
        self.builder.get_object("label_welcome1").set_text(_("Welcome to %s!") % "HamoniKR 6.0")
        self.builder.get_object("label_welcome2").set_text(_("This program will ask you some questions and set up HamoniKR on your computer."))
